...
namespace SE_ScriptCollection.Templates.Methods
{
    class Methods : MyGridProgram
    {
        #region Constants
        private readonly string [] LCD_NAME = { "LCD - Left (Name)", "LCD - Middle (Name)", "LCD - Right (Name)" };
        private const string STORAGE_KEY = "<>";
        const string BATTERY_NAME = "Battery (Name)";
        const string CONNECTOR_NAME = "<> Connector - Bottom (Name)";
        const string COCKPIT_NAME = "<> Cockpit (Name)";
